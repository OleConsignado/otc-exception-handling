...
export CLASS_LIBRARY_PROJ_DIR=Source/Otc.ExceptionHandling

./cicd-common.sh $@

export CLASS_LIBRARY_PROJ_DIR=Source/Otc.Mvc.Filters

./cicd-common.sh $@

export CLASS_LIBRARY_PROJ_DIR=Source/Otc.SwaggerSchemaFiltering
